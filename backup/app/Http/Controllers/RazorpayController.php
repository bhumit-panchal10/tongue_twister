...
class RazorpayController extends Controller
{
    ...
    public function razorPaySuccess(Request $request)
    {
        ...
        if ($generated_signature == $razorpay_signature) {
            ...
            $file = file_get_contents($root . '/tongue_twister/mailers/checkoutmail.html', 'r');
            ...
            foreach ($cartItems as $cartItem) {
                $html .= '<tr>
                    <td>' . $i . '</td>
                    <td>' . $cartItem['name'] . '</td>
                    <td><img width="48" height="48" src=https://getdemo.in/tongue_twister/Product/Thumbnail/' . $cartItem['attributes']['image'] . '></td>
