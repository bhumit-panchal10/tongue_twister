                    ...
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="header_social text-right">
                            <ul>
                                ...
                                <li><a href="https://www.instagram.com/tonguetwister01/"><i class="ion-social-instagram-outline"></i></a></li>
                            </ul>
                        </div>
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                <li class="menu-item-has-children @if (request()->routeIs('FrontIndex')) {{ 'active' }} @endif">
                                    <a href="{{route('FrontIndex')}}">Home</a>
                                </li>
                                <li class="menu-item-has-children @if (request()->routeIs('FrontAbout')) {{ 'active' }} @endif">
                                    <a href="{{route('FrontAbout')}}">about Us</a>
                                </li>
                                 <li class="menu-item-has-children @if (request()->routeIs('FrontCategory')) {{ 'active' }} @endif">
                                    <a href="#">Products</a>
                                    <ul class="sub-menu">
                                        <?php
                                ...
                                <li class="menu-item-has-children @if (request()->routeIs('front.blog')) {{ 'active' }} @endif">
                                    <a href="{{route('front.blog')}}"> Blog</a>
                                </li>
                                <li class="menu-item-has-children @if (request()->routeIs('FrontContactUs')) {{ 'active' }} @endif">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="main_menu menu_position">
                                <nav>
                                    <ul>
                                        <li><a class="@if (request()->routeIs('FrontIndex')) {{ 'active' }} @endif" href="{{route('FrontIndex')}}">home</a>

                                        </li>
                                        <li><a class="@if (request()->routeIs('FrontAbout')) {{ 'active' }} @endif" href="{{route('FrontAbout')}}">About Us</a>

                                        </li>

                                        <li><a class="@if (request()->routeIs('FrontCategory')) {{ 'active' }} @endif" href="#">Products <i class="fa fa-angle-down"></i></a>
                                        ...
                                        <li><a class="@if (request()->routeIs('front.blog')) {{ 'active' }} @endif" href="{{ route('front.blog') }}"> Blog</a></li>
                                        <li><a class="@if (request()->routeIs('FrontContactUs')) {{ 'active' }} @endif" href="{{ route('FrontContactUs') }}"> Contact Us</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <!--main menu end-->
