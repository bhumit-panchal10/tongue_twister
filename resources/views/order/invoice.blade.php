...
<table style="width: 100%;">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="text-align: center;background-color: #b80000;color: white;">Sr No</td>
            <td style="text-align: center;background-color: #b80000;color: white;">Product Name</td>
            <td style="text-align: center;background-color: #b80000;color: white;">Qty</td>
            <td style="text-align: center;background-color: #b80000;color: white;">Rate</td>
            <td style="text-align: center;background-color: #b80000;color: white;">Amount</td>
        ...
        <tr>
            ...
            <td style="text-align: center;background-color: #B80100;color: white;" colspan="1">Total</td>
            <td colspan="1">Rs.{{ $data->amount ?? 0 }}</td>
        </tr>
        <tr>
            <td style="border: 1px solid white;border-right: 1px solid black;" colspan="3"></td>
            <td style="text-align: center;background-color: #B80100;color: white;" colspan="1">Shipping Charges</td>
        ...
        <tr>
            <td style="border: 1px solid white;border-right: 1px solid black;" colspan="3"></td>
            <td style="text-align: center;background-color: #B80100;color: white;" colspan="1">Discount</td>
            <td colspan="1">Rs.{{ $data->discount }}</td>
        </tr>
        {{-- <tr>
        <td style="border: 1px solid white;border-right: 1px solid black;" colspan="3"></td>
        <td style="text-align: center;background-color: #B80100;color: white;" colspan="1">Gst</td>
        <td colspan="1">₹50.00</td>
        </tr> --}}
        <tr>
            <td style="border: 1px solid white;border-right: 1px solid black;" colspan="3"></td>
            <td style="text-align: center;background-color: #B80100;color: white;" colspan="1">Net Amount</td>
