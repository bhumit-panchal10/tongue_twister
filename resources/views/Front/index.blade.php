...
.action_links ul li button:hover {
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="slider_content">
                                <h1>Tongue Twister Mouth Fresheners</h1>
                                <p>
    ...
    <!--shipping area start-->
    <section class="shipping_area py-5 mb-64">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_shipping col_2">
                        ...
                        <div class="shipping_content">
                            <h3>Support 24/7</h3>
                            <p>Contact us 24 hours a day, 7 days a week <br>whatsapp no : 8780418312</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_shipping col_4">
                        ...
                        <div class="shipping_content">
                            ...
                            <p>100% payment Secure with Razorpay</p>
                        </div>
                    </div>
                </div>
            </div>
