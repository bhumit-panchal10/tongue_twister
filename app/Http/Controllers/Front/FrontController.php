...
class FrontController extends Controller
{
    ...
    public function contact_us(Request $request)
    {
        ...
        $toMail = "tonguetwister2023@gmail.com";
    ...
    public function checkoutstore(Request $request)
    {
        ...
        $ttorderid = 'tt' . $OrderId;

        $update = DB::table('order')
            ->where(['order_id' => $OrderId])
            ->update([
                'tt_order_id' => 'tt' . $OrderId
            ]);
    ...
    public function forgotpasswordsubmit(Request $request)
    {
        ...
        if (!empty($Customer)) {
            ...
            $file = str_replace('#email', 'http://tongue-twister.in/New-Password/' . $token, $file);
            // dd($file);
            $setting = DB::table("setting")->select('email')->first();
    ...
    public function searchproduct(Request $request)
    {
        ...
        return view('Front.product', compact('Product', 'categorysearch', 'search', 'seo'));
        // return response()->json([
        //     'product' => $product,
    ...
    public function category(Request $request, $id = null)
    {
        ...
        return view('Front.product', compact('Product', 'seo'));
    }
    ...
    public function FrontCategory(Request $request, $id)
    {
        $HeaderSearch = $request->headersearch;
        $Category = Category::orderBy('categoryId', 'desc')->get();
        $seo = Category::select('meta_description','head','body', 'meta_title', 'categoryname as meta_keyword')->where(['slugname' => $id])->first();
        $Product = Product::select(
            'product.productId',
            'product.categoryId',
            'product.productname',
        ...
        DB::commit();
        return view('Front.category', compact('Product', 'Category', 'id', 'ProductCount', 'seo'));
    ...
    public function blog(Request $request)
    {
        ...
        return view('Front.blog', compact('seo', 'blogs'));
    }
    ...
    public function blog_detail(Request $request, $id)
    {
        ...
        return view('Front.blog_detail', compact('Blog', 'RecentBlog'));
    }
}
