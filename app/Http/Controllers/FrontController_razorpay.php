...
class FrontController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        DB::commit();
        return view('frontview.index', compact('Category', 'Product', 'Testimonial', 'AllCategory', 'Offers', 'Banner'));
    }
    ...
    public function checkoutstore(Request $request)
    {
        ...
        //\Cart::clear();
        return redirect()->route('razorpay.index', $OrderId)->with('invalidcaptcha', 'Invalid captcha code!');
